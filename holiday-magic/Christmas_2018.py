'''
This file is a bit incomplete. The original plan is unfinished and I ran out fo time for this holiday season.
I may try to get this project working at some point, but the 2019 christmas event will be different.
This is mostly kept here for refrence purposes and may be deleted at some point.
I'm moving away from using psycopg2 and will be using more abstraction for my sql
'''

import psycopg2, random, discord
...
def setup(bot):
    bot.add_cog(Christmas_2018(bot))

if __name__ == "__main__":
    '''
    This was supposed to add the gifts to the database but had trouble interfacing using the SQL.
    May fix this at some point, but I'm just leaving it here for now.
    '''
    gift_list = [
